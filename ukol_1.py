...
strCisloBaliku=input("Vlozte kód baliku:")

if strCisloBaliku in baliky:
  if baliky[strCisloBaliku] == True:
    print(f"Balik a kódem {strCisloBaliku} byl předán kurýrovi.")
  else:
    print(f"Balik s kódem {strCisloBaliku} zatím nebyl předán kurýrovi")
else:
  print(f"Kód balíku neexistuje.")